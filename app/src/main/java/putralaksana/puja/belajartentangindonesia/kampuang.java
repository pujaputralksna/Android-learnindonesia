...
public class kampuang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apuse);
        ...
        jdl_lagu.setText("KAMPUANG NAN JAUH DI MATO\nAsal : Sumatera Barat");
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.kampuang);
